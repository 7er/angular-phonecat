...
describe('PhoneList', () => {
  ...
  it('should create "phones" model with 2 phones fetched from xhr',
    inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
      return tcb.createAsync(<Type>PhoneListComponent)
  ...
  it('should update based on the query',
    inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
      return tcb.createAsync(<Type>PhoneListComponent)
        .then((fixture: ComponentFixture<PhoneListComponent>) => {
          fixture.detectChanges();
          let compiled = fixture.debugElement.nativeElement;
          expect(compiled.querySelectorAll('.phone-list-item').length).toBe(2);
          fixture.componentInstance.query = "blask";
          fixture.detectChanges();
  ...
  it('should set the default value of orderProp model',
    inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
      return tcb.createAsync(<Type>PhoneListComponent)
        .then((fixture: ComponentFixture<PhoneListComponent>) => {
          fixture.detectChanges();
          expect(fixture.componentInstance.orderProp).toEqual('age');
          let compiled = fixture.debugElement.nativeElement;
          expect(
            compiled.querySelector('select option:last-child').selected
          ).toBe(true);

          //compiled.querySelector('select option:first-child').dispatchEvent(new Event("click"));
          //expect(fixture.componentInstance.orderProp).toEqual('name');
          fixture.componentInstance.orderProp = 'name';
          fixture.detectChanges();
          expect(
